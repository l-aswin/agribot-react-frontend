...
const CONFIG_KEYS = ['device_id', 'server_url', 'serial_port', 'serial_baud_rate', 'camera_index', 'confidence_threshold'];
const MOCK_SETTINGS = {
  device_id: 'DEV-001',
...
export default function Settings() {
  ...
  const [editRow,      setEditRow]      = useState(null);  // key being edited
  ...
  function startEdit(key) {
    setEditRow(key);
    setEditVal(config[key] ?? '');
  }

  function saveEdit(key) {
    setConfig(c => ({ ...c, [key]: editVal }));
    setEditRow(null);
  }
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            ...
            <div className="flex flex-wrap gap-3 items-end">
              <div className="flex-1 min-w-[200px]">
                ...
                <select value={selectedDev} onChange={e => { setSelectedDev(e.target.value); setConfig(null); setBanner(null); }}
